...
namespace SODMotives
{
    ...
    internal static class DebugTools
    {
        ...
        // DEV toggle: force the game's OWN next sniper to ExCopSniper so a VANILLA one can be observed (the game
        // rarely schedules ExCopSniper). The game's debugMurderPreset/debugMO fields are NOT honored by the
